		    ...
		    <div class="resume-body p-5">
			    <section class="resume-section summary-section mb-5">
				    ...
				    <div class="resume-section-content">
					    <p class="mb-0"><?php echo "Currently I'm attending Northern Kentucky University with major in Applied Software Engineering. I transferred from a community college after getting my Associate's degree." ?></p>
						<p class="mb-0"><br><?php echo "Some languages I'm proficient in are C#, Javascript, and HTML & CSS. I also have experience using GIT and Github." ?></p>
				    </div>
						    ...
						    <div class="resume-section-content">
							    <div class="resume-timeline position-relative">
								    <article class="resume-timeline-item position-relative pb-5">
									    ...
									    <div class="resume-timeline-item-header mb-2">
										    <div class="d-flex flex-column flex-md-row">
										        <h3 class="resume-position-title font-weight-bold mb-1"><?php echo "IT Support" ?></h3>
										        <div class="resume-company-name ms-auto"><?php echo "Maysville Community and Technical College" ?></div>
										    </div><!--//row-->
										    <div class="resume-position-time"><?php echo "2021 - Present" ?></div>
									    </div><!--//resume-timeline-item-header-->
									    <div class="resume-timeline-item-desc">
										    <p><?php echo "A student worker position in the IT department at Maysville Community and Technical College. Consists of assisting with computer problems, network issues, and printing issues." ?></p>
								    ...
								    <article class="resume-timeline-item position-relative pb-5">
									    ...
									    <div class="resume-timeline-item-header mb-2">
										    <div class="d-flex flex-column flex-md-row">
										        <h3 class="resume-position-title font-weight-bold mb-1"><?php echo "Work-Based Learning IT Job" ?></h3>
										        <div class="resume-company-name ms-auto"><?php echo"Bracken County High School" ?></div>
										    </div><!--//row-->
										    <div class="resume-position-time"><?php echo "2020 - 2021" ?></div>
									    </div><!--//resume-timeline-item-header-->
									    <div class="resume-timeline-item-desc">
										    <p><?php echo "A Work-Based learning IT job completed during Senior year of High School. Consisted of assisting students and teachers with computer problems and repairing Chromebooks." ?></p>
									    </div><!--//resume-timeline-item-desc-->
